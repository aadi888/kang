...
<script src="http://code.jquery.com/jquery-latest.js"></script>
		...
		<link rel="stylesheet" href="css-temp/list.css">
		<link rel="stylesheet" href="css-temp/style.css">
		<script src="js-temp/jquery.js"></script>
		<script src="js-temp/jquery-migrate-1.1.1.js"></script>
		<script src="js-temp/jquery.equalheights.js"></script>
		<script src="js-temp/main.js"></script>
		<script src="js-temp/jquery.ui.totop.js"></script>
		<script src="js-temp/jquery.easing.1.3.js"></script>
		<script src="js-temp/m.js"></script>
		<script>
...
<!-- 1 -->
							<li>
								<div class="card-front">
									<div class="text2">Teeth Whitening</div>
							...
							<li>
								<div class="card-front">
									<div class="text2">Cosmetic Bonding</div>
									<p>If you have teeth that have stains that cannot be removed by bleaching, and veneers or crowns are not necessary, then cosmetic bonding might be a good option for you. Cosmetic bonding is an affordable, quick and painless way to repair many cosmetic flaws or injuries.</p>
								</div>
								<div class="card-back">
									<h2><a href="#">Click here</a></h2>
								</div>
...
<p>Dental bonding sculpts individual teeth without requiring removal of any tooth structure. This technique bonds a composite material that looks, acts and feels like the real thing, to an existing tooth. This procedure usually doesn't require the use of an anesthetic; is relatively quick to apply; gives an immediate result and is less expensive than veneers.</p>
							...
							<li>
								<div class="card-front">
									<div class="text2">White Composite Fillings</div>
...
<!-- 2 -->
							<li>
								<div class="card-front">
									<div class="text2">Crowns</div>
									<p>Teeth are often restored using silver or porcelain fillings. However, when too much of a tooth's structure is removed to support a filling, a crown or "cap" may be needed.</p>
								</div>
								<div class="card-back">
									<h2><a href="#">Click here</a></h2>
								</div>
...
<p>A crown essentially covers a tooth to restore it to its natural shape and size. This permanent covering fits over your original tooth to strengthen or improve the appearance of the tooth. Fitting a crown generally requires at least two visits to the dentist's office.</p>								
							...
							<li>
								<div class="card-front">
									<div class="text2">Inlays and Onlays</div>
									<p align="center">When more than a third of a tooth's biting surface is damaged, a dentist will often use an inlay or onlay.</p>
								</div>
								<div class="card-back">
									<h2><a href="#">Click here</a></h2>
								</div>
								<!-- Content -->
							<div class="all-content">
									<div class="text2">Inlays and Onlays</div><br/>
							...
							<li>
								<div class="card-front">
									<div class="text2">Bridges</div>
									<p>Healthy and strong teeth support and maintain your jaw alignment. That is why when you lose one or more teeth, your remaining teeth may shift, and the ability to chew and speak may be affected. A bridge replaces missing teeth with artificial teeth, eliminating the gap where those teeth had been. </p>
								</div>
								<div class="card-back">
									<h2><a href="#">Click here</a></h2>
								</div>
...
<!-- 3 -->
							<li>
								...
								<div class="all-content">
									<div class="text2">Dentures</div><br/>
									<p>Missing teeth can create a host of aesthetic and functional problems including sagging facial muscles, inability to eat certain foods and speak. Dentures may be your best solution if you've lost all your natural teeth due to periodontal disease, tooth decay or injury.
Fitting a patient for dentures does not have to be a traumatic experience. During the preliminary visit, the remaining teeth are removed and a model is made of the patient's jaw. An immediate denture may be fitted so the patient does not have to be without teeth while the mouth tissue heals. Once the mouth tissue is completely healed, the patient is fitted with their custom dentures.</p>
							...
							<li>
								<div class="card-front">
									<div class="text2">Dental Implants</div>
...
<p>The procedure requires a titanium root be fitted into your jaw to replace the lost tooth's root. Once the implant is anchored into the bone, the bone around the implant requires six weeks to six months of healing. Once the bone has healed, a support post and replacement tooth is anchored onto the implant.</p>
							...
							<li class="last">
								<div class="card-front">
									<div class="text2">Periodontal Therapy</div>
